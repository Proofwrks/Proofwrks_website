...
export default function ShareButtons({ url, title }: ShareButtonsProps) {
  ...
  const btn =
    "inline-flex items-center justify-center h-10 w-10 rounded-full border border-border text-muted hover:text-foreground hover:border-foreground/20 transition-colors duration-200";

  return (
    <div className="flex items-center gap-3">
      <span className="text-[13px] font-medium text-muted mr-1">Share</span>
      ...
      >
        {copied ? (
          <svg className="w-[16px] h-[16px]" fill="none" viewBox="0 0 24 24" strokeWidth={2.2} stroke="currentColor">
